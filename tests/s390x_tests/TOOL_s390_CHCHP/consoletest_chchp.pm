...
# start of modification for s390 test TOOL_s390_CHCHP    
    my $TC_PATH = get_var('TC_PATH') . "/TOOL_s390_chchp/";
    ...
    assert_script_run "./lschp-main.sh";
    assert_script_run "./chchpmain.sh 0.36";
