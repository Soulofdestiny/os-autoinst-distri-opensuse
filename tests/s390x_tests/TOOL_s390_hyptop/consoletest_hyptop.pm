...
# start of modification for s390 test TOOL_s390_hyptop    
    my $TC_PATH = get_var('TC_PATH') . "/TOOL_s390_hyptop/";
    assert_script_run "wget -r -np -R 'index.html*'  http://$TC_PATH"; 
