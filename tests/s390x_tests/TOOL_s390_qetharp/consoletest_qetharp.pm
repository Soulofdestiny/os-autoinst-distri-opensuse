...
# modified for running the testcase TOOL_s390_qetharp on s390x.
...
# start of modification for s390 test TOOL_s390_qetharp    
    my $TC_PATH = get_var('TC_PATH') . "/TOOL_s390_qetharp/";
    ...
    assert_script_run ("./10S_cleanup_s390_qetharp.sh");
    assert_script_run ("./20S_prepare_s390_qetharp.sh", timeout => 1000);
    assert_script_run ("./30S_qetharp_test.sh", timeout => 1000);
    assert_script_run ("./40S_Ping_Test.sh", timeout => 1000);
